...
Route::group(['middleware' => ['auth', 'verified']], function() {
	...
	Route::get('/down-line/{slug}','ProfileController@refrealtors');

	Route::get('/realtor/{slug}','ProfileController@user');
	Route::get('/up-down-line/','ProfileController@updateDownlineView');
	Route::get('/up-down-line/{updown}','ProfileController@updateDownline');
	Route::get('/uplineupdate/{id}','ProfileController@updateUpline');
	Route::post('updateupline','ProfileController@uplineupdate')->name('upline.update');
